          ...
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                ...
                <button type="button" className="absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shadow-md transition-all durartion-500 ease-in-out" onClick={() => setImageAsset(null)}>
                  <MdDelete/>
                </button>
              </div>
            )}
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
              ...
              <div className="flex flex-col">
                <div>
                  ...
                  <select onChange={(event) => setCategory(event.target.value)} className="outline-none w-4/5 text-base border-b-2 border-gray-200 rounded-md cursor-pointer">
